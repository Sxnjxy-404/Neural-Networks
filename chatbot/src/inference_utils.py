...
def load_artifacts(model_dir: str):
 with open(os.path.join(model_dir, r'C:\Users\Sanja\chatbot\src\artifacts\tokenizer.json'), 'r', encoding='utf-8')as f:
  tok = tokenizer_from_json(f.read())
 with open(os.path.join(model_dir, r'C:\Users\Sanja\PycharmProjects\chatbot\src\artifacts\meta.json'), 'r') as f:
  meta = json.load(f)
 model = tf.keras.models.load_model(r"C:\Users\Sanja\PycharmProjects\chatbot\src\artifacts\seq2seq.keras")
